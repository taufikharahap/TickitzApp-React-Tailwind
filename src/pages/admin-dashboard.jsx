        ...
        <>
            ...
            <main className='font-Mulish min-h-screen mt-16 md:mt-24 bg-[#EFF0F6] py-20 overflow-x-hidden'>
                <section id='dashboard' className='tabcontent flex flex-col gap-y-10'>
                    <section className='w-[80%] flex flex-col gap-y-10 bg-white mx-auto rounded-[10px] p-16 overflow-x-hidden'>
                        <h3 className='text-[#14142B] text-nowrap text-lg md:text-2xl font-bold'>Sales Chart</h3>
                        <div className=''>
                            <form className='flex flex-row gap-x-5' action="">
                                <select className='bg-[#EFF0F6] rounded-[8px] text-[#4E4B66] text-base font-semibold px-3 py-3 w-[20%] outline-none cursor-pointer' name="movie-name" id="">
                    ...
                    <section className='w-[80%] flex flex-col gap-y-10 bg-white mx-auto rounded-[10px] p-16 overflow-x-hidden'>
                        ...
                        <div className=''>
                            <form className='flex flex-row gap-x-5' action="">
                                ...
                                <select className='bg-[#EFF0F6] rounded-[8px] text-[#4E4B66] text-base font-semibold px-3 py-3 w-[20%] outline-none cursor-pointer' name="movie-category" id="">
